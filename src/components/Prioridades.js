...
const Prioridad = () => {
  ...
  const handleCalculate = () => {
    ...
    if (inputType === 'lambdaMu') {
      ...
      if (muValue <= lambda1) {
        setErrors({ general: "μ debe ser mayor que λ1 para la estabilidad de la fórmula."});
        return;
      }
      ...
      // --- Aplicando tus fórmulas para el modo Q y Ts ---
    ...
    <div className="space-y-8 w-full">
      ...
      <div className="bg-gradient-to-br from-gray-800 to-gray-700 shadow-lg rounded-2xl p-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            <label htmlFor="inputType" className="block text-emerald-400 text-base font-medium mb-2">
              Modo de Cálculo
            </label>
            <select
              id="inputType"
              value={inputType}
              onChange={(e) => { setInputType(e.target.value); clearFields(); }}
          ...
          <div className="relative">
            <label htmlFor="w0" className="block text-emerald-400 text-base font-medium mb-2">
              W0: Tiempo restante del cliente en servicio
            </label>
            <input type="number" id="w0" value={w0} onChange={(e) => setW0(e.target.value)}
              className="w-full p-4 bg-gray-800 text-gray-100 border border-gray-700 rounded-lg"
              placeholder="Ej. 0.5" step="0.01" min="0" required />
          </div>
        </div>
        ...
        {inputType === "lambdaMu" ? (
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div><label className="block text-emerald-400 mb-2">λ1: Tasa llegada Clase 1</label><input value={class1Lambda} onChange={e=>setClass1Lambda(e.target.value)} type="number" placeholder="Ej. 2" className="w-full p-4 bg-gray-800 rounded-lg"/></div>
            <div><label className="block text-emerald-400 mb-2">λ2: Tasa llegada Clase 2</label><input value={class2Lambda} onChange={e=>setClass2Lambda(e.target.value)} type="number" placeholder="Ej. 3" className="w-full p-4 bg-gray-800 rounded-lg"/></div>
            <div><label className="block text-emerald-400 mb-2">μ: Tasa de Servicio</label><input value={mu} onChange={e=>setMu(e.target.value)} type="number" placeholder="Ej. 10" className="w-full p-4 bg-gray-800 rounded-lg"/></div>
          </div>
        ) : (
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            <div><label className="block text-emerald-400 mb-2">Q1: Clientes cola Clase 1</label><input value={q1} onChange={e=>setQ1(e.target.value)} type="number" placeholder="Ej. 5" className="w-full p-4 bg-gray-800 rounded-lg"/></div>
            <div><label className="block text-emerald-400 mb-2">Ts1: Tiempo serv. Clase 1</label><input value={ts1} onChange={e=>setTs1(e.target.value)} type="number" placeholder="Ej. 0.1" className="w-full p-4 bg-gray-800 rounded-lg"/></div>
            <div><label className="block text-emerald-400 mb-2">Q2: Clientes cola Clase 2</label><input value={q2} onChange={e=>setQ2(e.target.value)} type="number" placeholder="Ej. 8" className="w-full p-4 bg-gray-800 rounded-lg"/></div>
            <div><label className="block text-emerald-400 mb-2">Ts2: Tiempo serv. Clase 2</label><input value={ts2} onChange={e=>setTs2(e.target.value)} type="number" placeholder="Ej. 0.1" className="w-full p-4 bg-gray-800 rounded-lg"/></div>
          </div>
        )}
      ...
      {results && (
        ...
        className="mt-8 p-8 bg-gradient-to-br from-gray-800 to-gray-700 rounded-2xl shadow-lg">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            {/* Wq1 */}
            <div className="p-4 bg-gray-900 rounded-lg">
                <h4 className="text-lg font-medium text-emerald-400">Tiempo de espera de Cola Clase 1 (W1)</h4>
                <p className="text-2xl font-bold text-white mt-2">
            ...
            {/* W1 */}
            <div className="p-4 bg-gray-900 rounded-lg">
                <h4 className="text-lg font-medium text-emerald-400">Tiempo Total en sistema Clase 1 (W1)</h4>
                <p className="text-2xl font-bold text-white mt-2">
            ...
            {/* Wq2 */}
            <div className="p-4 bg-gray-900 rounded-lg">
                <h4 className="text-lg font-medium text-emerald-400">Tiempo de espera de Cola Clase 2 (Wq2)</h4>
                <p className="text-2xl font-bold text-white mt-2">
            ...
            {/* W2 */}
            <div className="p-4 bg-gray-900 rounded-lg">
                <h4 className="text-lg font-medium text-emerald-400">Tiempo Total en sistema Clase 2 (W2)</h4>
                <p className="text-2xl font-bold text-white mt-2">
